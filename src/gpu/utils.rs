...
lazy_static::lazy_static! {
    static ref GPU_INFOS: HashMap<String, GPUInfo> = {
        let mut gpu_infos : HashMap<String, GPUInfo> = vec![
            ...
            ("GeForce RTX 3080".to_string(), GPUInfo{core_count: 8704, max_window_size: 9, chunk_size_scale: 45, best_chunk_size_scale: 45, g2_chunk_divider: 2}),
            ...
            ("GeForce RTX 2080 Ti".to_string(), GPUInfo{core_count: 4352, max_window_size: 7, chunk_size_scale: 12, best_chunk_size_scale: 12, g2_chunk_divider: 1}),
