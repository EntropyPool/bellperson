...
lazy_static::lazy_static! {
    static ref GPU_INFOS: HashMap<String, GPUInfo> = {
        let mut gpu_infos : HashMap<String, GPUInfo> = vec![
            ...
            ("GeForce RTX 3090".to_string(), GPUInfo{core_count: 10496, max_window_size: 9, chunk_size_scale: 80, best_chunk_size_scale: 80, g2_chunk_divider: 1 as f32, reserved_mem_ratio: 0.05}),
            ("GeForce RTX 3080".to_string(), GPUInfo{core_count: 8830, max_window_size: 9, chunk_size_scale: 25, best_chunk_size_scale: 25, g2_chunk_divider: 2 as f32, reserved_mem_ratio: 0.2}),
