    ...
    C: Circuit<E::Fr> + Send,
{
    ...
    create_proof_batch_priority_inner_v0(circuits, params, r_s, s_s, priority)
}

#[allow(clippy::type_complexity)]
fn create_proof_batch_priority_inner_v0_inner<Scalar, C>(
    circuits: Vec<C>,
) -> Result<
    (
        Instant,
...
pub fn create_proof_batch_priority_inner_v0<E, C, P: ParameterSource<E>>(
    circuits: Vec<C>,
    params: P,
    r_s: Vec<E::Fr>,
    s_s: Vec<E::Fr>,
...
where
    ...
    C: Circuit<E::Fr> + Send,
{
    info!("Proof V0: Bellperson {} is being used!", BELLMAN_VERSION);

    let (start, mut provers, input_assignments, aux_assignments) =
        create_proof_batch_priority_inner_v0_inner(circuits)?;
